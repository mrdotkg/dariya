...
//                            a[0].innerHTML='<iframe src="'+elem.find('.project-media').data('granth')+'" height = "100%" frameborder="no" width = "100%"></iframe>';
                            a[0].innerHTML=' <iframe src="http://docs.google.com/gview?url=http://measdot.github.io/dariya/assets/pdf/viveksagar.pdf&embedded=true" style="width:790px; height:500px;" frameborder="0">Loading...</iframe>';
                        },1000)
                    }
                });
            });
