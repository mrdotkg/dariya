                ...
                $('#preview-media.flexslider').flexslider({
                    ...
                    start: function(){
                        setTimeout(function(){
                            ...
                            a[0].innerHTML=' <iframe src="http://docs.google.com/gview?url=http://measdot.github.io/dariya/'+elem.find('.project-media').data('granth')+'&embedded=true" style="width:790px; height:500px;" frameborder="0">Loading...</iframe>';
                        },1000)
                    }
                });
            });
